...
const handleSubmit=async(e)=>{
    ...
    e.preventDefault();
    try{
        await axios.post(`http://localhost:4002/locations`,  { name: locationName });
...
const confirmDeletion = (id) => {
  ...
  <div className="mb-3">
    ...
    <input type="text" className="form-control" id="location" aria-describedby="location" required
    ...
    {locations.length===0?(
        ...
        <tr key={l.id}>
            ...
            {editingId===l.id?(
                ...
                onClick={()=>handleUpdate(l.id)}>Save</button>
            ...
            onClick={()=>confirmDeletion(l.id)}/></td>
        </tr>
    )))}
